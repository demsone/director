...
http.createServer((req,res)=>{
 ...
 if(pathname==='/__director_v4'){res.writeHead(200,{'Content-Type':'text/plain'});res.end('director-v4-functional');return;}
...
}).listen(port,'127.0.0.1',()=>console.log(`Director v4: http://127.0.0.1:${port}`));
