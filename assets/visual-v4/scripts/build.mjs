...
for(const s of screens){const root=s.root,b=root.absoluteBoundingBox;const html=render(root,b,s);
 const doc=`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>${escape(s.name)} — Director v4</title><link rel="stylesheet" href="tokens.css"><link rel="stylesheet" href="visual.css"><script type="module" src="functional-runtime.js"></script></head><body data-screen="${s.key}" data-visual-only="false"><main class="source-frame" aria-label="${escape(s.name)}" style="width:${px(b.width)};height:${px(b.height)}">${html}</main></body></html>`;
